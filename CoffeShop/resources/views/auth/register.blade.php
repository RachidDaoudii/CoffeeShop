...
<section class="home-slider owl-carousel">
  <div class="slider-item" style="background-image: url({{ asset('FrontEndCoffe/images/bg_3.jpg')}} );" data-stellar-background-ratio="0.5">
            ...
            <x-guest-layout>
                <x-jet-authentication-card>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div>
                            <x-jet-label for="name" value="{{ __('Name') }}" class="text-justify" />
                        ...
                        <div class="mt-4">
                            <x-jet-label for="password_confirmation" value="{{ __('Confirm Password') }}" class="text-justify"/>
